"""Balanced multi-head waveform regressor for `dataset_big6` (variant 0_5).
...
OUTPUT_DIR = "model_training_big6_fmsynth3_0_5"
MODEL_NAME = "model_training_big6_fmsynth3_0_5"
...
def build_model(
    ...
    return Model(input_layer, outputs, name="complete_multihead_balanced_0_5")
