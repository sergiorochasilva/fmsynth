"""Multi-head CNN regressor for `dataset_big4` (variant 0_5).

Architecture:
- Raw waveform input
- Deeper 1D CNN stack with wider early pooling
...
OUTPUT_DIR = "model_training_big4_fmsynth3_0_5"
MODEL_NAME = "model_training_big4_fmsynth3_0_5"
...
# Configuração para reduzir consumo de memória de GPU
BATCH_SIZE = int(os.getenv("TRAIN_BATCH_SIZE", "10"))
PRED_BATCH_SIZE = int(os.getenv("PRED_BATCH_SIZE", "20"))
...
def build_model(
    ...
    x_n = MaxPooling1D(pool_size=4, name="pool_1")(x_n)
    ...
    x_n = MaxPooling1D(pool_size=4, name="pool_2")(x_n)
    ...
    hidden_1 = max(hidden_dim, 128)
    hidden_2 = max(hidden_dim // 2, 64)
    ...
    return Model(input_layer, outputs, name="complete_multihead_cnn_0_5")
