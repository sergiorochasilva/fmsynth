...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pred-dir", type=Path, default=Path("nsynth-pred-big16_0_1"))
    parser.add_argument("--output-dir", type=Path, default=Path("evaluation_nsynth_big16_0_1"))
