"""Balanced multi-head waveform regressor for `dataset_big6` (variant 0_6).
...
OUTPUT_DIR = "model_training_big6_fmsynth3_0_6"
MODEL_NAME = "model_training_big6_fmsynth3_0_6"
