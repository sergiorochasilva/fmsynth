"""Evaluate split big17 `0_2` NSynth resynthesis against stronger baselines.
...
Data flow:
- Input: `nsynth-test/audio`, `nsynth-test/examples.json`, and `nsynth-pred-big17_0_2/`
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate split big17 resynthesis against NSynth baselines.")
    ...
    parser.add_argument("--pred-dir", type=Path, default=Path("nsynth-pred-big17_0_2"))
    parser.add_argument("--output-dir", type=Path, default=Path("evaluation_nsynth_big17_0_2"))
