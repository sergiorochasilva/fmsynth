"""Compact FM multitask model for `dataset_big10`, version 0_2.
...
OUTPUT_DIR = Path(os.getenv("OUTPUT_DIR", "model_training_big10_fmsynth3_0_2"))
MODEL_NAME = "model_training_big10_fmsynth3_0_2"
...
CNN_BATCH_DEFAULT = os.getenv("TRAIN_BATCH_SIZE", "4")
...
def build_model(input_len: int, n_algorithm_classes: int, n_ratio_classes: int) -> Model:
    ...
    return Model(
        ...
        name="compact_rawwave_multitask_big10_0_2",
    )
