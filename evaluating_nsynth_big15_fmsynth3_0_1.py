"""Evaluate split big15 NSynth resynthesis against stronger baselines.
...
Data flow:
- Input: `nsynth-test/audio`, `nsynth-test/examples.json`, and `nsynth-pred-big15_0_1/`
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pred-dir", type=Path, default=Path("nsynth-pred-big15_0_1"))
    parser.add_argument("--output-dir", type=Path, default=Path("evaluation_nsynth_big15_0_1"))
