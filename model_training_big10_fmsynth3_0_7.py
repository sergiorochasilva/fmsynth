"""Multi-resolution spectral FM multitask model for `dataset_big10`, version 0_7.
...
OUTPUT_DIR = Path(os.getenv("OUTPUT_DIR", "model_training_big10_fmsynth3_0_7"))
MODEL_NAME = "model_training_big10_fmsynth3_0_7"
...
def build_model(input_len: int, n_algorithm_classes: int, n_ratio_classes: int) -> Model:
    ...
    return Model(
        ...
        name="compact_multirespectral_multitask_big10_0_7",
    )
