"""Spectral FM multitask model for `dataset_big10`, version 0_4.

Architecture:
- Raw waveform input
- Differentiable log-mel front-end inside the model
- Residual 1D CNN backbone over the time axis of the spectrogram
...
OUTPUT_DIR = Path(os.getenv("OUTPUT_DIR", "model_training_big10_fmsynth3_0_4"))
MODEL_NAME = "model_training_big10_fmsynth3_0_4"
...
def build_model(input_len: int, n_algorithm_classes: int) -> Model:
    ...
    x = Lambda(logmel_frontend, name="logmel_frontend")(inputs)
    ...
    return Model(
        ...
        name="compact_spectral_multitask_big10_0_4",
    )
