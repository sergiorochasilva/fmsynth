"""Multi-head CNN regressor for `dataset_big4` (variant 0_3).

Architecture:
- Raw waveform input
- 1D CNN stack with large pooling windows
...
OUTPUT_DIR = "model_training_big4_fmsynth3_0_3"
MODEL_NAME = "model_training_big4_fmsynth3_0_3"
...
def build_model(
    ...
    x_n = MaxPooling1D(pool_size=16, name="pool_1")(x_n)
    ...
    x_n = MaxPooling1D(pool_size=16, name="pool_2")(x_n)
    ...
    x_n = MaxPooling1D(pool_size=16, name="pool_3")(x_n)

    features_flat = Flatten(name="features_flatten")(x_n)
    ...
    return Model(input_layer, outputs, name="complete_multihead")
