"""Resynthesize NSynth audio from the split `big17` `0_2` predictions.

Architecture:
- Loads the merged predictions from the `0_2` cascade
...
- Output: resynthesized `.wav` files in `nsynth-pred-big17_0_2/`
"""
...
DEFAULT_PRED_JSON = Path("nsynth-pred-big17_0_2") / f"params_pred_nsynth_{MODEL_NAME}.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Resynthesize NSynth using split big17 predictions.")
