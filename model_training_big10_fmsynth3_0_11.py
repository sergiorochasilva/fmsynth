"""Algorithm-focused multi-resolution spectral FM classifier for `dataset_big10`, version 0_11.
...
OUTPUT_DIR = Path(os.getenv("OUTPUT_DIR", "model_training_big10_fmsynth3_0_11"))
MODEL_NAME = "model_training_big10_fmsynth3_0_11"
...
def build_model(
    ...
    algo_joint = Concatenate(name="algo_joint_concat")([algo_branch, algo_prefix_branch, algo_suffix_branch, x])
    algo_joint = Dense(max(DENSE_UNITS, 256), activation="swish", name="algo_joint_dense")(algo_joint)
    ...
    return Model(
        inputs=inputs,
        outputs=[algorithm_head, algorithm_prefix_head, algorithm_suffix_head],
        name="compact_multirespectral_multitask_big10_0_11",
    )
