"""Evaluate split big14 NSynth resynthesis against stronger baselines.
...
Data flow:
- Input: `nsynth-test/audio`, `nsynth-test/examples.json`, and `nsynth-pred-big14_0_1/`
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate split big14 resynthesis against NSynth baselines.")
    ...
    parser.add_argument("--pred-dir", type=Path, default=Path("nsynth-pred-big14_0_1"))
    parser.add_argument("--output-dir", type=Path, default=Path("evaluation_nsynth_big14_0_1"))
