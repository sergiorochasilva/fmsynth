"""Resynthesize NSynth audio from `big13` 0_2 predictions.

Architecture:
- Loads predicted algorithm, ratio, carrier frequency, structural controls, and envelopes from the `big13` 0_2 model
...
- Output: resynthesized `.wav` files in `nsynth-pred-big13_0_2/`
"""
...
DEFAULT_PRED_JSON = Path("nsynth-pred-big13_0_2") / f"params_pred_nsynth_{MODEL_NAME}.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Resynthesize NSynth using big13 0_2 predictions.")
