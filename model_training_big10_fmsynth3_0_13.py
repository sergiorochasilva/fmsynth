"""Algorithm-focused FM classifier for `dataset_big10`, version 0_13.
...
OUTPUT_DIR = Path(os.getenv("OUTPUT_DIR", "model_training_big10_fmsynth3_0_13"))
MODEL_NAME = "model_training_big10_fmsynth3_0_13"
