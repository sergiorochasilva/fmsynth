"""Conditioned split FM predictors for `dataset_big13`, version 0_2.
...
MODEL_PREFIX = "model_training_big15_fmsynth3_0_2"
...
def build_model(input_len: int, n_algorithm_classes: int, target_group: str | None = None, target_specs: list[dict] | None = None) -> Model:
    ...
    if target_group == "algorithm":
        ...
        carrier_branch = Concatenate(name="carrier_condition_concat")([shared_dense, algorithm_condition])
        ...
        mod_branch = Concatenate(name="mod_condition_concat")([shared_dense, algorithm_condition, carrier_condition])
