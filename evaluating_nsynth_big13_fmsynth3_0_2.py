"""Evaluate NSynth resynthesis against stronger NSynth baselines for big13 0_2.
...
Data flow:
- Input: `nsynth-test/audio`, `nsynth-test/examples.json`, and `nsynth-pred-big13_0_2/`
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--pred-audio-dir", type=Path, default=Path("nsynth-pred-big13_0_2"))
    parser.add_argument("--examples-json", type=Path, default=Path("nsynth-test/examples.json"))
    parser.add_argument("--output-dir", type=Path, default=Path("evaluation_nsynth_big13_0_2"))
    parser.add_argument(
