"""Multi-resolution spectral FM multitask model for `dataset_big10`, version 0_10.
...
MODEL_NAME = "model_training_big10_fmsynth3_0_10"
...
def build_model(
    ...
    return Model(
        ...
        name="compact_multirespectral_multitask_big10_0_10",
    )
...
def main() -> None:
    ...
    model.compile(
        ...
        loss_weights={
            "algorithm_head": 2.8,
            "algorithm_prefix_head": 0.6,
            "algorithm_suffix_head": 0.6,
            "ratio_class_head": 0.5,
            "freq_log2_head": 0.4,
        },
    )
