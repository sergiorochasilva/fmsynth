"""Resynthesize NSynth audio from the hierarchical `big16` predictions.

Architecture:
- Loads the merged predictions from the hierarchical `big16` algorithm hierarchy plus the split `big15_0_2` carrier/modulator models
...
- Output: resynthesized `.wav` files in `nsynth-pred-big16_0_1/`
"""
...
DEFAULT_PRED_JSON = Path("nsynth-pred-big16_0_1") / f"params_pred_nsynth_{MODEL_NAME}.json"
...
DEFAULT_DATASET_PARAMS = Path("dataset_big16/parameters.csv")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Resynthesize NSynth using hierarchical big16 predictions.")
