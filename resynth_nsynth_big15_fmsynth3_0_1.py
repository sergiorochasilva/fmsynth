"""Resynthesize NSynth audio from the conditioned split `big15` predictions.

Architecture:
- Loads the merged predictions from the three split `big15` models
...
- Output: resynthesized `.wav` files in `nsynth-pred-big15_0_1/`
"""
...
DEFAULT_PRED_JSON = Path("nsynth-pred-big15_0_1") / f"params_pred_nsynth_{MODEL_NAME}.json"
