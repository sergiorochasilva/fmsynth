"""Predict FM parameters for NSynth using `model_training_big12_fmsynth3_0_2`.

Architecture:
- Loads the trained multi-task CNN from the `big12` experiment variant `0_2`
- Preprocesses NSynth audio into the expected waveform tensor
- Exports predicted `algorithm`, `ratio_carrier`, and `frequencia_base`

Data flow:
- Input: `nsynth-test/audio` and the saved `model_training_big12_fmsynth3_0_2.keras`
...
from model_training_big12_fmsynth3_0_2 import build_model, logmel_frontend

MODEL_NAME = "model_training_big12_fmsynth3_0_2"
MODEL_DIR = Path("model_training_big12_fmsynth3_0_2")
