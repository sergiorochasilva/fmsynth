"""Resynthesize NSynth audio from the split `big14` predictions.

Architecture:
- Loads the merged predictions from the three split `big14` models
...
- Output: resynthesized `.wav` files in `nsynth-pred-big14_0_1/`
"""
...
DEFAULT_PRED_JSON = Path("nsynth-pred-big14_0_1") / f"params_pred_nsynth_{MODEL_NAME}.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Resynthesize NSynth using split big14 predictions.")
