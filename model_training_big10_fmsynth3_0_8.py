"""Multi-resolution spectral FM multitask model for `dataset_big10`, version 0_8.
...
MODEL_NAME = "model_training_big10_fmsynth3_0_8"
...
def build_model(input_len: int, n_algorithm_classes: int, n_ratio_classes: int) -> Model:
    ...
    algo_branch = Dense(max(DENSE_UNITS // 2, 192), activation="swish", name="algo_branch_dense")(x)
    ...
    algo_branch = Dense(max(DENSE_UNITS // 3, 160), activation="swish", name="algo_branch_dense_2")(algo_branch)
