"""Encode `dataset_big5` audio into latent vectors with a trained encoder.
...
Data flow:
- Input: `dataset_big5/sample_*.wav` plus encoder/preprocess artifacts
- Output: `latent_big5_fmsynth3_0_1.npy` and `encoding_metadata_big5_fmsynth3_0_1.json`
"""
...
BASE_PATH = os.getenv("ENC_BASE_PATH", "dataset_big5")
MODEL_DIR = os.getenv("ENC_MODEL_DIR", "autoencoder_training_big5_fmsynth3_0_1")
OUTPUT_DIR = os.getenv("ENC_OUTPUT_DIR", "dataset_big5_encoded")

ENCODER_FILENAME = os.getenv(
    "ENC_ENCODER_FILENAME",
    "encoder_autoencoder_training_big5_fmsynth3_0_1.keras",
)
PREPROCESS_FILENAME = os.getenv(
    "ENC_PREPROCESS_FILENAME",
    "preprocess_autoencoder_training_big5_fmsynth3_0_1.save",
)
...
def main() -> None:
    ...
    npy_path = os.path.join(OUTPUT_DIR, "latent_big5_fmsynth3_0_1.npy")
    meta_out = os.path.join(OUTPUT_DIR, "encoding_metadata_big5_fmsynth3_0_1.json")
