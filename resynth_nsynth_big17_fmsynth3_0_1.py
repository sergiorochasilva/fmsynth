"""Resynthesize NSynth audio from the conditioned split `big17` `0_1` predictions.

Architecture:
- Loads the merged predictions from the split `big17` cascade
...
- Output: resynthesized `.wav` files in `nsynth-pred-big17_0_1/`
"""
...
DEFAULT_PRED_JSON = Path("nsynth-pred-big17_0_1") / f"params_pred_nsynth_{MODEL_NAME}.json"
