"""Predict FM parameters for NSynth using the conditioned split `big15` `0_2` models.
...
Data flow:
- Input: `nsynth-test/audio`, `nsynth-test/examples.json`, and the `big15` `0_2` split model directories
