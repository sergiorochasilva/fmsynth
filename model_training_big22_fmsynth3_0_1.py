"""Algorithm-focused FM multitask model for `dataset_big19`, version 0_1.
...
OUTPUT_DIR = Path(os.getenv("OUTPUT_DIR", "model_training_big22_fmsynth3_0_1"))
MODEL_NAME = "model_training_big22_fmsynth3_0_1"
...
AUDIO_MANIFEST_PATH = BASE_PATH / "audio_big19_manifest.json"
AUDIO_LEGACY_CACHE_PATH = BASE_PATH / "audio_big19_int16.npy"
...
def build_model(
    ...
    return Model(
        ...
        name="compact_multirespectral_multitask_big22_0_1",
    )
...
def main() -> None:
    ...
    y_train_full.to_csv(OUTPUT_DIR / "y_train_big22.csv", index=False)
    y_test_full.to_csv(OUTPUT_DIR / "y_test_big22.csv", index=False)
