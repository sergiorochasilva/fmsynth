"""Multi-resolution spectral FM multitask model for `dataset_big10`, version 0_6.
...
OUTPUT_DIR = Path(os.getenv("OUTPUT_DIR", "model_training_big10_fmsynth3_0_6"))
MODEL_NAME = "model_training_big10_fmsynth3_0_6"
...
def build_model(input_len: int, n_algorithm_classes: int) -> Model:
    ...
    algo_branch = Dense(max(DENSE_UNITS // 2, 160), activation="swish", name="algo_branch_dense")(x)
    ...
    algo_branch = Dense(max(DENSE_UNITS // 3, 128), activation="swish", name="algo_branch_dense_2")(algo_branch)
    ...
    return Model(
        ...
        name="compact_multirespectral_multitask_big10_0_6",
    )
...
def main() -> None:
    ...
    model.compile(
        ...
        loss={
            "algorithm_head": sparse_categorical_focal_loss(gamma=1.4),
