"""Compact FM multitask model for `dataset_big10`, version 0_3.

Architecture:
- Raw waveform input
- Compact 1D CNN backbone over the raw waveform
- Shared dense trunk with one categorical head for `algorithm`
...
OUTPUT_DIR = Path(os.getenv("OUTPUT_DIR", "model_training_big10_fmsynth3_0_3"))
MODEL_NAME = "model_training_big10_fmsynth3_0_3"
...
def build_model(input_len: int, n_algorithm_classes: int) -> Model:
    ...
    return Model(
        ...
        name="compact_rawwave_multitask_big10_0_3",
    )
