"""Evaluate hierarchical big16 NSynth resynthesis against stronger baselines.

Architecture:
- Loads paired NSynth originals and hierarchical-model resynthesized outputs
...
Data flow:
- Input: `nsynth-test/audio`, `nsynth-test/examples.json`, and `nsynth-pred-big16_0_1/`
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate hierarchical big16 resynthesis against NSynth baselines.")
    ...
    parser.add_argument("--pred-dir", type=Path, default=Path("nsynth-pred-big16_0_2"))
    parser.add_argument("--output-dir", type=Path, default=Path("evaluation_nsynth_big16_0_2"))
